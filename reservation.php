            ...
            <div class="row"> 
                 <section  class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
                      <div  style="padding-top:15%;font-size: 60px;text-align: center">
                          <h2><strong><?php echo"RESERVATION"; ?></strong></h2>
                ...
                <table class="table table-striped table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Arrivée</th>
                      <th>Prix</th>
                      <th>la date de votre réservation</th>
                  ...
                  <tbody>
                      ...
                      {
                          echo"<tr>";
                          echo"<form action='paiement.php' method='POST'><td><input type='text' name='cv' value='$row[0]' readonly></td>";
                          echo"<td>$row[2]</td>";
                          echo"<td>$row[4]</td>";
                          echo"<td>$row[5]</td>";
                          echo "<td>";
                          echo "<input type='date' name='dateV' required></td>";
                          echo "<td><input type='number'  name='nombreTicket' value='1' min='1'  max='20' required></td> ";
                        echo"<td><input value='réserver' type='submit' class='btn btn-info'></td>";
                          echo "</form>";
                          echo"</tr>";
                        }
                        $cur->closeCursor();
